...
public class ProjectController {
    ...
    public ProjectController(MainFrame frame,
        ...
        infoPanelController.setProjectController(this);
 ...
 in the exception's description).
    ...
    private boolean createNewProject() throws JAXBException, Exception {
        ...
        Project newCurrentProject = new Project(projectName, projectLocation, projectFile);
    ...
    private void setCurrentProject(Project currentProject) {
        ...
        infoPanelController.setCurrentProject(currentProject);
    }
}
