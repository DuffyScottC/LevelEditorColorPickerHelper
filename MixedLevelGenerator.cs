...
public class MixedLevelGenerator : MonoBehaviour {
	...
	public TEntity[] tileEntities = new TEntity[] {
		new TEntity("Entity 1", new Color32(255, 0, 0, 255)),
		new TEntity("Entity 2", new Color32(1, 255, 0, 255)),
		new TEntity("Entity 3", new Color32(255, 0, 255, 255)),
	...
	public void Start() {
		for (int i = 0; i < tileEntitiesTileBases.Length; i++) {
			tileEntities[i].tile = tileEntitiesTileBases[i];
		}
